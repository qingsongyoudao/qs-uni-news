		...
		setTimeout(function() {
			try {
				...
				if (!pageNum) {
					...
					let newObj = {
						id:id,
						title: "新增" + id + " 苹果 iPhone 12 Pro 工厂程序清单图首曝：非纯直角边框，边缘类似弧线过渡",
						content: "有消息称苹果今年预计将发布四款iPhone，包括一款5.4英寸，一款6.7英寸，还有两款6.1英寸的机型。"
					};
					list.push(newObj);
				} else {
					//模拟上拉加载返回的数据
					for (let i = 0; i < pageSize; i++) {
						...
						let newObj = {
							id:upIndex,
							title: "新闻" + upIndex + " 苹果 iPhone 12 Pro 工厂程序清单图首曝：非纯直角边框，边缘类似弧线过渡",
							content: "其中6.1英寸机型和6.7英寸机型将是高端型号，而6.1英寸的iPhone和5.4英寸的iPhone 12则会是相对较低端的机型。同时这四款机型均将搭载A14芯片。"
						};
						list.push(newObj);
					}
