	...
	<qs-page :header="true" :footer="true">
		...
		<view class="news-detail">
			...
			<view class="detail-content">
				...
				<view class="u-m-b-20">
					了解到，良维科技是全球第二大连接器、电源线与信号线生产企业，总部位于台湾省台北市，主要客户包括苹果、亚马逊、戴森、惠普、戴尔、联想、三星与LG。在当前的苹果供应链中，良维科技是仅次于日本住友的
					Type-C 接口供货商。而此次李淳正预计良维方面可获得约 30% 的苹果订单，约 7500 万条。
				</view>
				<view class="u-m-b-20">
					一项新的使用历史记录功能提供了有关 Mac 在过去 24 小时或过去 10 天内的电池电量的详细信息，分为 “电池电量”和 “屏幕使用情况”，以便您查看电池的性能信息。
				</view>
				<view class="u-m-b-20">
					目前似乎没有 iOS 上使用最多的应用的详细清单，但它确实可以更好地了解随着时间的推移电池电量是如何消耗的。除
					“使用历史记录”部分外，还有“电池和电源适配器”部分，它们取代了之前通过“节能”板块提供的功能。您可以选择何时关闭显示器，启用或禁用电源休眠等功能，并根据电池使用情况和连接电源后的使用情况来拆分设置，日程安排功能也存在于此。
				</view>
				<view class="u-m-b-20">
					在菜单栏中，单击电池图标现在可以估计剩余电池电量，该功能已于 2016 年从 macOS Sierra 中删除。当时，苹果表示 macOS
					Sierra中的电池指示器不准确，导致有关电池性能的信息出现混乱。
				</view>
				<view class="u-m-b-20">
					菜单栏的电池图标还显示能耗很高的应用，如 macOS Catalina
					中一样，并且它提供了打开“电池偏好设置”的选项。但是，菜单栏中似乎没有可选择显示（或隐藏）当前电量百分比的选项。
				</view>
